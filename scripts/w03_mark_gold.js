...
let c=0; for (const e of arr) { if (e.hexagramId>=9 && e.hexagramId<=12) { e.qualityLevel="gold"; e.reviewed=true; e.needsHumanReview=false; e.needsExpansion=false; e.reviewedBy="line-category-gold-wave-03"; e.reviewedAt="2026-07-14"; c++; } }
console.log("Marked Wave 03 gold:", c);
